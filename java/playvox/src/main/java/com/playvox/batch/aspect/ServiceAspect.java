...
public class ServiceAspect {
    ...
    @Around(value = "execution(* com.playvox.batch.service.*.*(..)) && args(..)")
    ...
    @AfterThrowing(value = "execution(* com.playvox.batch.service.*.*(..)) and args(str1,str2)")
    ...
    @Around(value = "execution(* com.playvox.batch.repo.*.*(..)) && args(..)")
    ...
    @AfterThrowing(value = "execution(* com.playvox.batch.repo.*.*(..)) and args(str1,str2)")

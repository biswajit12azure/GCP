package com.notification.mail.aspect;
...
public class ServiceAspect {
    ...
    @Around(value = "execution(* com.notification.mail.service.*.*(..)) && args(..)")
    ...
    @AfterThrowing(value = "execution(* com.notification.mail.service.*.*(..)) and args(str1,str2)")

package com.khoros.batch.aspect;
...
public class ServiceAspect {
    ...
    @Around(value = "execution(* com.khoros.batch.service.*.*(..)) && args(..)")
    ...
    @AfterThrowing(value = "execution(* com.khoros.batch.service.*.*(..)) and args(str1,str2)")
    ...
    @Around(value = "execution(* com.khoros.batch.repo.*.*(..)) && args(..)")
    ...
    @AfterThrowing(value = "execution(* com.khoros.batch.repo.*.*(..)) and args(str1,str2)")
    ...
    @Around(value = "execution(* com.khoros.batch.job.*.*(..)) && args(..)")
    public Object aroundJOBMethods(ProceedingJoinPoint joinPoint) throws Throwable {
        String methodName = joinPoint.getSignature().getName();
        String className = joinPoint.getTarget().getClass().getSimpleName();
        Object[] methodArgs = joinPoint.getArgs();
